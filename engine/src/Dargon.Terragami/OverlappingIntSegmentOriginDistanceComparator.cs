...
#if DEBUG
         if (GeometryOperations.Clockness(p.X, p.Y, a.X1, a.Y1, a.X2, a.Y2) != Clockness.CounterClockWise) {
            throw new InvalidStateException();
         }
         if (GeometryOperations.Clockness(p.X, p.Y, b.X1, b.Y1, b.X2, b.Y2) != Clockness.CounterClockWise) {
            throw new InvalidStateException();
         }
#endif
...
#if DEBUG
         if (GeometryOperations.Clockness(p.X, p.Y, (cDouble)a.X1, (cDouble)a.Y1, (cDouble)a.X2, (cDouble)a.Y2) != Clockness.CounterClockWise) {
            throw new InvalidStateException();
         }
         if (GeometryOperations.Clockness(p.X, p.Y, (cDouble)b.X1, (cDouble)b.Y1, (cDouble)b.X2, (cDouble)b.Y2) != Clockness.CounterClockWise) {
            throw new InvalidStateException();
         }
